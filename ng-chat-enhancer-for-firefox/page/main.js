...
function init() {
	// Add events.
	browser.runtime.onMessage.addListener(runtimeMessage);
...
function initObserve() {
	...
	obsULCtn = new MutationObserver(function(mutations) { mutations.forEach(userListCtnObserve); });
	...
	function userListCtnObserve(mutation) {
		...
		var obsUL = new MutationObserver(function(mutations) { mutations.forEach(userListObserve); });
	...
	obsMLCtn = new MutationObserver(function(mutations) { mutations.forEach(messagesListCtnObserve); });
	...
	function messagesListCtnObserve(mutation) {
		...
		// Observe the generated class list.
		var obsML = new MutationObserver(function(mutations) { mutations.forEach(messagesListObserve); });
